...
exports.sendEmailNode = extension_tools_1.createNodeDescriptor({
    ...
    function: async ({ cognigy, config }) => {
        ...
        try {
            ...
            const response = await axios_1.default.post(`${baseUrl}/api/now/v1/email`, data, {
                headers: {

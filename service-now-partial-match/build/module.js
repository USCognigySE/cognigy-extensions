...
const getWorkOrder_1 = require("./nodes/workOrder/getWorkOrder");
// Import Connections
...
exports.default = extension_tools_1.createExtension({
    nodes: [
        ...
        getWorkOrder_1.getWorkOrderNode,
        getWorkOrder_1.onSuccessGetWorkOrder,
        getWorkOrder_1.onErrorGetWorkOrder,

...
export const findEntity = createNodeDescriptor({
    ...
    fields: [
        ...
        },
        {
            ...
            description: "Comma-separated list of properties to return for contacts",
            condition: {
                key: "entityType",
                value: "contact"
            }
        },
        {
            ...
            description: "Comma-separated list of properties to return for companies",
            condition: {
                key: "entityType",
                value: "company"
            }
        },
        {
            ...
            description: "Comma-separated list of properties to return for tickets",
            condition: {
                key: "entityType",
                value: "ticket"
            }
    ...
    function: (async ({ cognigy, config }: IFindEntityParams) => {
        ...
        try {
            ...
            const propertyArray = properties.split(',').map(prop => prop.trim()).filter(prop => prop !== '');

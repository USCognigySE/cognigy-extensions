...
exports.getArticlesNode = extension_tools_1.createNodeDescriptor({
    ...
    function: async ({ cognigy, config }) => {
        ...
        try {
            ...
            const response = await axios_1.default.get(`${baseUrl}/api/sn_km_api/knowledge/articles`, {
                headers: {

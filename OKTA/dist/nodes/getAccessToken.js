...
exports.getAccessToken = (0, extension_tools_1.createNodeDescriptor)({
    ...
    sections: [
        {
            ...
            fields: ["connection", "oktaBaseUrl", "resultKey"]
        },
        {
            key: "caching",
    ...
    function: async ({ cognigy, config }) => {
        ...
        const { connection, oktaBaseUrl, resultKey, inputTokenKey, debugMode } = typedConfig;
        try {
            ...
            const tokenUrl = `${oktaBaseUrl}/oauth2/default/v1/token`;
            ...
            const response = await axios_1.default.post(tokenUrl, 'grant_type=client_credentials&scope=openid', {
                headers: {
